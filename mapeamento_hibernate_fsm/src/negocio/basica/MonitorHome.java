...
/**
 * Home object for domain model class Monitor.
 * @see negocio.basica.Monitor
 * @author Hibernate Tools
 */
public class MonitorHome {

    private static final Log log = LogFactory.getLog(MonitorHome.class);
    ...
    public void persist(Monitor transientInstance) {
        log.debug("persisting Monitor instance");
        try {
    ...
    public Monitor merge(Monitor detachedInstance) {
        ...
        try {
            Monitor result = (Monitor) sessionFactory.getCurrentSession()
    ...
    public Monitor findById( int id) {
        ...
        try {
            Monitor instance = (Monitor) sessionFactory.getCurrentSession()
                    .get("negocio.basica.Monitor", id);
            if (instance==null) {
    ...
    public List findByExample(Monitor instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("negocio.basica.Monitor")
